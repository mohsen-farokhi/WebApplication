    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "فارسی", new DateTime(2020, 12, 30, 18, 56, 21, 897, DateTimeKind.Local).AddTicks(8208), true, false, true, 1065, "fa-IR", "فارسی (ایران)", new DateTime(2020, 12, 30, 18, 56, 21, 901, DateTimeKind.Local).AddTicks(2261) });

            migrationBuilder.InsertData(
                table: "Cultures",
                columns: new[] { "Id", "DisplayName", "InsertDateTime", "IsActive", "IsDeleted", "IsSystem", "Lcid", "Name", "NativeName", "UpdateDateTime" },
                values: new object[] { 2, "English", new DateTime(2020, 12, 30, 18, 56, 21, 902, DateTimeKind.Local).AddTicks(386), true, false, true, 1033, "en-US", "English (United States)", new DateTime(2020, 12, 30, 18, 56, 21, 902, DateTimeKind.Local).AddTicks(406) });
